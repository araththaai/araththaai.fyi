...
const zExportMap = _zod.z.record(_zod.z.string(), _zod.z.object({
    ...
    _isFallbackUpgradeable: _zod.z.boolean().optional()
}));
...
const experimentalSchema = {
    ...
    requestInsights: _zod.z.boolean().optional(),
    ...
    imgOptOperationCache: _zod.z.boolean().optional().nullable(),
    ...
    cssChunking: _zod.z.union([
        ...
        _zod.z.literal('loose'),
        _zod.z.literal('graph'),
        _zod.z.strictObject({
            type: _zod.z.literal('strict')
        }),
        _zod.z.strictObject({
            type: _zod.z.literal('loose')
        }),
        _zod.z.strictObject({
    ...
    blockingSSR: _zod.z.boolean().optional(),
    ...
    turbopackMemoryEviction: _zod.z.union([
    ...
    turbopackModuleFragments: _zod.z.boolean().optional(),
    ...
    turbopackGenerateComponentChunks: _zod.z.boolean().optional(),
    turbopackSharedRuntime: _zod.z.boolean().optional(),
    ...
    serverComponentsHmrCancellation: _zod.z.boolean().optional(),
    authInterrupts: _zod.z.boolean().optional(),
    useCache: _zod.z.boolean().optional(),
    durableUseCacheEntries: _zod.z.boolean().optional(),
...
const configSchema = _zod.z.lazy(()=>_zod.z.strictObject({
        ...
        instrumentationClientInject: _zod.z.array(_zod.z.string()).optional(),
        partialPrefetching: _zod.z.union([
            _zod.z.boolean(),
            _zod.z.literal('unstable_eager')
        ]).optional(),
