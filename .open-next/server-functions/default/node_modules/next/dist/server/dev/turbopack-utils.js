        ...
        case 'page':
            {
                ...
                try {
                    ...
                    if (dev) {
                        ...
                        hooks == null ? void 0 : hooks.subscribeToChanges(serverKey, /** includeIssues=*/ false, route.dataEndpoint, ()=>{
                        ...
                        hooks == null ? void 0 : hooks.subscribeToChanges(clientKey, /** includeIssues=*/ false, route.htmlEndpoint, ()=>{
                            return {
                        ...
                        if (entrypoints.global.document) {
                            hooks == null ? void 0 : hooks.subscribeToChanges((0, _entrykey.getEntryKey)('pages', 'server', '_document'), /** includeIssues=*/ false, entrypoints.global.document, ()=>{
                                return {
                                    type: _hotreloadertypes.HMR_MESSAGE_SENT_TO_BROWSER.RELOAD_PAGE,
        ...
        case 'app-page':
            {
                ...
                if (dev) {
                    // TODO subscriptions should only be caused by the WebSocket connections
                    // otherwise we don't known when to unsubscribe and this leaking
                    hooks == null ? void 0 : hooks.subscribeToChanges(key, /** includeIssues=*/ true, route.rscHmrEndpoint, (change)=>{
                        var _hooks_handleServerComponentChanges;
                        ...
                        // Report the next compilation again
                        readyIds == null ? void 0 : readyIds.delete(pathname);
                        hooks == null ? void 0 : (_hooks_handleServerComponentChanges = hooks.handleServerComponentChanges) == null ? void 0 : _hooks_handleServerComponentChanges.call(hooks);
                    }, (e)=>{
                        return {
                            type: _hotreloadertypes.HMR_MESSAGE_SENT_TO_BROWSER.RELOAD_PAGE,
        ...
        case 'app-route':
            {
                ...
                if (dev) {
                    ...
                    hooks == null ? void 0 : hooks.subscribeToChanges(key, /** includeIssues= */ true, route.endpoint, ()=>undefined, (error)=>{
                        ...
                        console.error(Object.defineProperty(new Error(`Error in the "${page}" app-route HMR subscription`, {
                            cause: error
                        }), "__NEXT_ERROR_CODE", {
                            value: "E1448",
                            enumerable: false,
...
async function handleEntrypoints({ entrypoints, currentEntrypoints, currentEntryIssues, manifestLoader, devRewrites, logErrors, dev }) {
    ...
    if (middleware) {
        ...
        if (dev) {
            dev == null ? void 0 : dev.hooks.subscribeToChanges(key, /** includeIssues=*/ false, endpoint, async ()=>{
                const finishBuilding = dev.hooks.startBuilding(triggerName, undefined, true);
                await processMiddleware();
...
async function handlePagesErrorRoute({ currentEntryIssues, entrypoints, manifestLoader, devRewrites, productionRewrites, logErrors, hooks }) {
    if (entrypoints.global.app) {
        ...
        hooks.subscribeToChanges(key, /** includeIssues=*/ false, entrypoints.global.app, ()=>{
    ...
    if (entrypoints.global.document) {
        ...
        const writtenEndpoint = await entrypoints.global.document.writeToDisk();
        hooks.handleWrittenEndpoint(key, writtenEndpoint, false);
        hooks.subscribeToChanges(key, /** includeIssues=*/ false, entrypoints.global.document, ()=>{
            return {
                type: _hotreloadertypes.HMR_MESSAGE_SENT_TO_BROWSER.RELOAD_PAGE,
    ...
    if (entrypoints.global.error) {
        ...
        hooks.handleWrittenEndpoint(key, writtenEndpoint, false);
        hooks.subscribeToChanges(key, /** includeIssues=*/ false, entrypoints.global.error, ()=>{
            // There's a special case for this in `../client/page-bootstrap.ts`.
            // https://github.com/vercel/next.js/blob/08d7a7e5189a835f5dcb82af026174e587575c0e/packages/next/src/client/page-bootstrap.ts#L69-L71
            return {
                type: _hotreloadertypes.HMR_MESSAGE_SENT_TO_BROWSER.CLIENT_CHANGES
