...
function createLocalSpan({ name, attributes, links, startTime, traceId, spanId, parentSpanId, delegateSpan }) {
...
class LocalRecordingSpan {
    constructor({ name, attributes, links, startTime, delegateSpan, traceId, spanId, parentSpanId, requestIdentity }){
        this.name = name;
