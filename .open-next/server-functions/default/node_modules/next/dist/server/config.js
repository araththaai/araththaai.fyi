 ...
 */ function assignDefaultsAndValidate(dir, userConfig, silent, phase) {
    ...
    let lockFiles = undefined;
    if (!repoRoot) {
        const rootDirResult = (0, _findroot.findRootDirAndLockFiles)(dir);
...
async function loadConfigImpl(phase, dir, { customConfig, rawConfig, silent = true, reportExperimentalFeatures, reactProductionProfiling, debugPrerender, bundler }) {
    ...
    if (path == null ? void 0 : path.length) {
        var _userConfig_experimental, _userConfig_experimental1, _userConfig_experimental2, _userConfig_experimental3, _userConfig_experimental4;
        ...
        if (phase !== _constants.PHASE_PRODUCTION_SERVER && ((_userConfig_experimental3 = userConfig.experimental) == null ? void 0 : _userConfig_experimental3.useLightningcss)) {
            var _css, _this, _userConfig_experimental5;
            const { loadBindings } = require('../build/swc');
            const isLightningSupported = (_this = await loadBindings((_userConfig_experimental5 = userConfig.experimental) == null ? void 0 : _userConfig_experimental5.useWasmBinary)) == null ? void 0 : (_css = _this.css) == null ? void 0 : _css.lightning;
        ...
        if (userConfig.supportsImmutableAssets === undefined || ((_userConfig_experimental4 = userConfig.experimental) == null ? void 0 : _userConfig_experimental4.supportsImmutableAssets) === undefined) {
            var _userConfig_experimental6;
            const value = userConfig.supportsImmutableAssets ?? ((_userConfig_experimental6 = userConfig.experimental) == null ? void 0 : _userConfig_experimental6.supportsImmutableAssets);
