...
var require_root_of_the_server_0emy_m4 = __commonJS({
  ".next/server/edge/chunks/[root-of-the-server]__0emy-m4._.js"() {
    ...
    (globalThis.TURBOPACK || (globalThis.TURBOPACK = [])).push(["chunks/[root-of-the-server]__0emy-m4._.js", 74398, (e, t, r) => {
      ...
      }, r.version = "19.3.0-canary-756fdd47-20260727";
    }, 40049, (e, t, r) => {
      "use strict";
      t.exports = e.r(8946);
    }, 58217, (e) => {
...
Learn More: https://nextjs.org/docs/messages/node-module-in-edge-runtime`;
  ...
  `), Object.defineProperty(this, "__NEXT_ERROR_CODE", { value: "E1177", enumerable: false, configurable: true });
      ...
      var q, B, H, F, V, G, X, z, W, K, J, Q, Y, Z, ee, et, er = e.i(28042);
      ...
      let eY = (e10, t10) => {
        ...
        trace(...e10) {
          ...
          let { fn: s2, options: l2 } = "function" == typeof r2 ? { fn: r2, options: {} } : { fn: n2, options: { ...r2 } }, u2 = l2.spanName ?? t10, c2 = eq.has(t10) || "1" === process.env.NEXT_OTEL_VERBOSE;
          if (!(c2 || (null == a2 ? void 0 : a2.isRequestInsightsEnabled())) || l2.hideSpan) return s2();
          let d2 = this.getSpanContext((null == l2 ? void 0 : l2.parentSpan) ?? this.getActiveScopeSpan());
          d2 || (d2 = (null == eG ? void 0 : eG.active()) ?? eJ);
          let h2 = d2.getValue(e0), p2 = "number" != typeof h2 || !eZ.has(h2), f2 = e1++;
          return l2.attributes = { "next.span_category": "nextjs", "next.span_name": u2, "next.span_type": t10, ...l2.attributes }, eG.with(d2.setValue(e0, f2), () => this.runWithActiveSpan(u2, l2, d2, i2 && c2, o2, (e11) => {
            let r3;
            eF && t10 && eB.has(t10) && (r3 = "performance" in globalThis && "measure" in performance ? globalThis.performance.now() : void 0);
            let n3 = false, i3 = () => {
              !n3 && (n3 = true, eZ.delete(f2), r3 && performance.measure(`${eF}:next-${(t10.split(".").pop() || "").replace(/[A-Z]/g, (e12) => "-" + e12.toLowerCase())}`, { start: r3, end: performance.now() }));
            };
            if (p2 && eZ.set(f2, new Map(Object.entries(l2.attributes ?? {}))), s2.length > 1) try {
              return s2(e11, (t11) => {
        ...
        runWithActiveSpan(e10, t10, r2, n2, i2, a2) {
          if (n2) return this.getTracerInstance().startActiveSpan(e10, t10, (n3) => a2(i2 ? this.createLocalRecordingSpan(e10, t10, r2, n3) : n3));
          let o2 = this.createLocalRecordingSpan(e10, t10, r2), s2 = ez.setSpan(eG.active(), o2);
          return eV().withLocalSpan(o2, () => eG.with(s2, a2, void 0, o2));
        }
        createLocalRecordingSpan(e10, t10, r2, n2) {
          let i2 = ez.getSpanContext(r2), a2 = null == n2 ? void 0 : n2.spanContext();
          return eV().createLocalSpan({ name: e10, attributes: t10.attributes, links: t10.links, startTime: t10.startTime, delegateSpan: n2, traceId: (null == a2 ? void 0 : a2.traceId) ?? (null == i2 ? void 0 : i2.traceId), spanId: null == a2 ? void 0 : a2.spanId, parentSpanId: null == i2 ? void 0 : i2.spanId });
        }
        wrap(...e10) {
        ...
        startSpan(...e10) {
          var t10;
          let [r2, n2] = e10, i2 = n2 ? { ...n2, attributes: { "next.span_category": "nextjs", ...n2.attributes } } : { attributes: { "next.span_category": "nextjs" } }, a2 = this.getSpanContext(i2.parentSpan ?? this.getActiveScopeSpan()) ?? eG.active();
          if (!(null == (t10 = eV()) ? void 0 : t10.isLocalSpanRecordingEnabled())) return this.getTracerInstance().startSpan(r2, i2, a2);
          let o2 = this.isOpenTelemetryEnabled() ? this.getTracerInstance().startSpan(r2, i2, a2) : void 0;
          return this.createLocalRecordingSpan(r2, i2, a2, o2);
        }
        getSpanContext(e10) {
        ...
        withSpan(e10, t10) {
          let r2 = ez.setSpan(eG.active(), e10), n2 = eV();
          return (null == n2 ? void 0 : n2.isLocalRecordingSpan(e10)) ? n2.withLocalSpan(e10, () => eG.with(r2, t10)) : eG.with(r2, t10);
        }
          ...
          if ("/middleware" === t10.page || "/src/middleware" === t10.page || "/proxy" === t10.page || "/src/proxy" === t10.page) {
            ...
            return e4().trace(e$.execute, { spanName: `middleware ${w2.method}`, attributes: { "http.target": w2.nextUrl.pathname, "http.method": w2.method } }, async () => {
              try {
                ...
                return await eE.run(h3, () => e9.run(d3, t10.handler, w2, x2));
              } finally {
                setTimeout(() => {
                  r3.dispatchClose();
                }, 0);
      ...
      let { env: tA, stdout: tk } = (null == (et = globalThis) ? void 0 : et.process) ?? {}, tI = tA && !tA.NO_COLOR && (tA.FORCE_COLOR || (null == tk ? void 0 : tk.isTTY) && !tA.CI && "dumb" !== tA.TERM), tM = (e10, t10, r2, n2) => {
        let i2 = e10.substring(0, n2) + r2, a2 = e10.substring(n2 + t10.length), o2 = a2.indexOf(t10);
        return ~o2 ? i2 + tM(a2, t10, r2, o2) : i2 + a2;
      }, tj = (e10, t10, r2 = e10) => tI ? (n2) => {
      ...
      var tH = ((Y = {}).APP_PAGE = "APP_PAGE", Y.APP_ROUTE = "APP_ROUTE", Y.PAGES = "PAGES", Y.FETCH = "FETCH", Y.REDIRECT = "REDIRECT", Y.IMAGE = "IMAGE", Y), tF = ((Z = {}).APP_PAGE = "APP_PAGE", Z.APP_ROUTE = "APP_ROUTE", Z.PAGES = "PAGES", Z.FETCH = "FETCH", Z.IMAGE = "IMAGE", Z);
      function tV() {
      }
      new TextEncoder();
      ...
      class t7 {
        ...
        get readable() {
          ...
          if (Array.isArray(this.response)) return function(...e10) {
            ...
            let a2 = e10[i2];
            return (n2 = n2.then(() => a2.pipeTo(r2))).catch(tV), t10;
          }(...this.response);
      ...
      t9(process.env.NEXT_PRIVATE_RESPONSE_CACHE_TTL, 1e4), t9(process.env.NEXT_PRIVATE_RESPONSE_CACHE_MAX_SIZE, 150);
      var t5 = e.i(68886);
      ...
      class ri {
        ...
        async get(...e10) {
          ...
          if (ri.debug && (u2 === tF.FETCH ? console.log("FileSystemCache: get", s2, l2.tags, u2, !!c2) : console.log("FileSystemCache: get", s2, u2, !!c2)), (null == c2 || null == (r2 = c2.value) ? void 0 : r2.kind) === tH.APP_PAGE || (null == c2 || null == (n2 = c2.value) ? void 0 : n2.kind) === tH.APP_ROUTE || (null == c2 || null == (i2 = c2.value) ? void 0 : i2.kind) === tH.PAGES) {
        ...
        async set(e10, t10, r2) {
          ...
          if (t10.kind === tH.APP_ROUTE) {
            ...
            let n3 = t10.kind === tH.APP_PAGE, a2 = this.getFilePath(`${e10}.html`, n3 ? tF.APP_PAGE : tF.PAGES);
            if (i2.append(a2, t10.html), r2.fetchCache || r2.isFallback || r2.isRoutePPREnabled || i2.append(this.getFilePath(`${e10}${n3 ? ".rsc" : ".json"}`, n3 ? tF.APP_PAGE : tF.PAGES), n3 ? t10.rscData : JSON.stringify(t10.pageData)), (null == t10 ? void 0 : t10.kind) === tH.APP_PAGE) {
              let e11;
              if (t10.segmentData) {
                e11 = [];
      ...
      class rh {
        ...
        async get(e10, t10) {
          ...
          if (t10.kind === tF.FETCH) {
            let r3 = e9.getStore(), n3 = r3 ? e5(r3) : null;
            if (n3) {
      ...
      RegExp("\\n\\s+at Suspense \\(<anonymous>\\)(?:(?!\\n\\s+at (?:body|div|main|section|article|aside|header|footer|nav|form|p|span|h1|h2|h3|h4|h5|h6) \\(<anonymous>\\))[\\s\\S])*?\\n\\s+at __next_root_layout_boundary__ \\([^\\n]*\\)"), RegExp("\\n\\s+at __next_metadata_boundary__[\\n\\s]"), RegExp("\\n\\s+at __next_viewport_boundary__[\\n\\s]"), RegExp("\\n\\s+at __next_outlet_boundary__[\\n\\s]"), RegExp("\\n\\s+at __next_instant_validation_boundary__[\\n\\s]"), RegExp("\\n\\s+at __next_instant_slot_(\\d+)__[\\n\\s]"), ew(), e.s(["config", 0, { matcher: ["/admin/:path*"], runtime: "experimental-edge" }, "middleware", 0, function(e10) {
        let t10 = e10.cookies.get("next-auth.session-token") || e10.cookies.get("__Secure-next-auth.session-token");
        return e10.nextUrl.pathname.startsWith("/admin") && !t10 ? eu.redirect(new URL("/sign-in", e10.url)) : eu.next();
      }], 96592);
      let rg = { ...e.i(96592) }, rv = "/middleware", rm = rg.middleware || rg.default;
      ...
      e.s(["default", 0, rb, "handler", 0, r_], 58217);
    }]);
  }
});
  ...
  ".next/server/edge/chunks/turbopack-node_modules_next_dist_esm_build_templates_edge-wrapper_0a9xbl8.js"() {
    ...
    (globalThis.TURBOPACK || (globalThis.TURBOPACK = [])).push(["chunks/turbopack-node_modules_next_dist_esm_build_templates_edge-wrapper_0a9xbl8.js", { otherChunks: ["chunks/node_modules_next_dist_esm_build_templates_edge-wrapper_0_kjzx3.js", "chunks/[root-of-the-server]__0emy-m4._.js"], runtimeModuleIds: [35825] }]), (() => {
      ...
      async function v(e2, t2, r2) {
        ...
        let o2 = r2.included || [], l2 = o2.map((e3) => !!R.has(e3) || j.get(e3));
        if (l2.length > 0 && l2.every((e3) => e3)) return void await Promise.all(l2);
        for (let l3 of (n2 = M(e2, t2, T(r2.path)), o2)) j.has(l3) || j.set(l3, n2);
        await n2;
      }
      k.l = function(e2) {
        return v(r.Parent, this.m.id, e2);
      };
      let x = Promise.resolve(void 0), U = /* @__PURE__ */ new WeakMap();
      function M(t2, n2, o2) {
        let l2 = e.loadChunkCached(t2, o2), u2 = U.get(l2);
        if (void 0 === u2) {
          let e2 = U.set.bind(U, l2, x);
      ...
      }, N.resolve = (e2, t2) => __require.resolve(e2, t2), l.x = N, e = { registerChunk(e2, t2) {
...
var NextConfig = { "env": { "NEXT_PUBLIC_CLOUDINARY_CLOUD_NAME": "r0lvbyu3", "NEXT_PUBLIC_SUPABASE_URL": "https://tddajwtscnfnlfpklvjx.supabase.co", "NEXT_PUBLIC_SUPABASE_ANON_KEY": "eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJpc3MiOiJzdXBhYmFzZSIsInJlZiI6InRkZGFqd3RzY25mbmxmcGtsdmp4Iiwicm9sZSI6ImFub24iLCJpYXQiOjE3ODMzMDU4NzksImV4cCI6MjA5ODg4MTg3OX0.9_HNyBfxoNOqcpL77hgKotiz0ubqOkgy6vBUCs0_z74" }, "webpack": null, "typescript": { "ignoreBuildErrors": false }, "typedRoutes": false, "distDir": ".next", "cleanDistDir": true, "assetPrefix": "", "cacheMaxMemorySize": 52428800, "configOrigin": "next.config.ts", "useFileSystemPublicRoutes": true, "generateEtags": true, "pageExtensions": ["tsx", "ts", "jsx", "js"], "instrumentationClientInject": [], "poweredByHeader": true, "compress": true, "images": { "deviceSizes": [640, 750, 828, 1080, 1200, 1920, 2048, 3840], "imageSizes": [32, 48, 64, 96, 128, 256, 384], "path": "/_next/image", "loader": "default", "loaderFile": "", "domains": [], "disableStaticImages": false, "minimumCacheTTL": 14400, "formats": ["image/webp"], "maximumRedirects": 3, "maximumResponseBody": 5e7, "dangerouslyAllowLocalIP": false, "dangerouslyAllowSVG": false, "contentSecurityPolicy": "script-src 'none'; frame-src 'none'; sandbox;", "contentDispositionType": "attachment", "localPatterns": [{ "pathname": "**", "search": "" }], "remotePatterns": [{ "protocol": "https", "hostname": "res.cloudinary.com" }], "qualities": [75], "unoptimized": false, "customCacheHandler": false }, "devIndicators": { "position": "bottom-left" }, "onDemandEntries": { "maxInactiveAge": 6e4, "pagesBufferLength": 5 }, "basePath": "", "sassOptions": {}, "trailingSlash": false, "i18n": null, "productionBrowserSourceMaps": false, "excludeDefaultMomentLocales": true, "reactProductionProfiling": false, "reactStrictMode": null, "reactMaxHeadersLength": 6e3, "httpAgentOptions": { "keepAlive": true }, "logging": { "serverFunctions": true, "browserToTerminal": "warn" }, "compiler": {}, "expireTime": 31536e3, "staticPageGenerationTimeout": 60, "output": "standalone", "modularizeImports": { "@mui/icons-material": { "transform": "@mui/icons-material/{{member}}" }, "lodash": { "transform": "lodash/{{member}}" } }, "outputFileTracingRoot": "D:\\Projects\\Client\\Araththaai", "enablePrerenderSourceMaps": true, "cacheComponents": false, "cacheLife": { "default": { "stale": 300, "revalidate": 900, "expire": 4294967294 }, "seconds": { "stale": 30, "revalidate": 1, "expire": 60 }, "minutes": { "stale": 300, "revalidate": 60, "expire": 3600 }, "hours": { "stale": 300, "revalidate": 3600, "expire": 86400 }, "days": { "stale": 300, "revalidate": 86400, "expire": 604800 }, "weeks": { "stale": 300, "revalidate": 604800, "expire": 2592e3 }, "max": { "stale": 300, "revalidate": 2592e3, "expire": 31536e3 } }, "cacheHandlers": {}, "experimental": { "appNewScrollHandler": true, "coldCacheBadge": false, "devValidationWorker": true, "useSkewCookie": false, "cssChunking": true, "multiZoneDraftMode": false, "appNavFailHandling": false, "prerenderEarlyExit": true, "serverMinification": true, "linkNoTouchStart": false, "caseSensitiveRoutes": false, "cachedNavigations": false, "dynamicOnHover": false, "useOffline": false, "varyParams": true, "optimisticRouting": true, "instrumentationClientRouterTransitionEvents": false, "prefetchInlining": { "maxSize": 2048, "maxBundleSize": 10240 }, "preloadEntriesOnStart": true, "clientRouterFilter": true, "clientRouterFilterRedirects": false, "fetchCacheKeyPrefix": "", "proxyPrefetch": "flexible", "optimisticClientCache": true, "manualClientBasePath": false, "cpus": 7, "memoryBasedWorkersCount": false, "imgOptConcurrency": null, "imgOptOperationCache": null, "imgOptTimeoutInSeconds": 7, "imgOptMaxInputPixels": 268402689, "imgOptSequentialRead": null, "isrFlushToDisk": true, "workerThreads": false, "optimizeCss": false, "nextScriptWorkers": false, "scrollRestoration": false, "externalDir": false, "disableOptimizedLoading": false, "gzipSize": true, "craCompat": false, "esmExternals": true, "fullySpecified": false, "swcTraceProfiling": false, "forceSwcTransforms": false, "requestInsights": false, "largePageDataBytes": 128e3, "typedEnv": false, "parallelServerCompiles": false, "parallelServerBuildTraces": false, "ppr": false, "authInterrupts": false, "webpackMemoryOptimizations": false, "optimizeServerReact": true, "strictRouteTypes": false, "useTypeScriptCli": true, "removeUncaughtErrorAndRejectionListeners": false, "validateRSCRequestHeaders": true, "staleTimes": { "dynamic": 0, "static": 300 }, "reactDebugChannel": true, "serverComponentsHmrCache": true, "serverComponentsHmrCancellation": false, "staticGenerationMaxConcurrency": 8, "staticGenerationMinPagesPerWorker": 25, "transitionIndicator": false, "gestureTransition": false, "inlineCss": false, "useCache": false, "globalNotFound": false, "browserDebugInfoInTerminal": "warn", "lockDistDir": true, "proxyClientMaxBodySize": 10485760, "hideLogsAfterAbort": false, "mcpServer": true, "turbopackFileSystemCacheForDev": true, "turbopackFileSystemCacheForBuild": false, "turbopackInferModuleSideEffects": true, "turbopackPluginRuntimeStrategy": "childProcesses", "turbopackMemoryEvictionMode": "auto", "optimizePackageImports": ["lucide-react", "date-fns", "lodash-es", "ramda", "antd", "react-bootstrap", "ahooks", "@ant-design/icons", "@headlessui/react", "@headlessui-float/react", "@heroicons/react/20/solid", "@heroicons/react/24/solid", "@heroicons/react/24/outline", "@visx/visx", "@tremor/react", "rxjs", "@mui/material", "@mui/icons-material", "recharts", "react-use", "effect", "@effect/schema", "@effect/platform", "@effect/platform-node", "@effect/platform-browser", "@effect/platform-bun", "@effect/sql", "@effect/sql-mssql", "@effect/sql-mysql2", "@effect/sql-pg", "@effect/sql-sqlite-node", "@effect/sql-sqlite-bun", "@effect/sql-sqlite-wasm", "@effect/sql-sqlite-react-native", "@effect/rpc", "@effect/rpc-http", "@effect/typeclass", "@effect/experimental", "@effect/opentelemetry", "@material-ui/core", "@material-ui/icons", "@tabler/icons-react", "mui-core", "react-icons/ai", "react-icons/bi", "react-icons/bs", "react-icons/cg", "react-icons/ci", "react-icons/di", "react-icons/fa", "react-icons/fa6", "react-icons/fc", "react-icons/fi", "react-icons/gi", "react-icons/go", "react-icons/gr", "react-icons/hi", "react-icons/hi2", "react-icons/im", "react-icons/io", "react-icons/io5", "react-icons/lia", "react-icons/lib", "react-icons/lu", "react-icons/md", "react-icons/pi", "react-icons/ri", "react-icons/rx", "react-icons/si", "react-icons/sl", "react-icons/tb", "react-icons/tfi", "react-icons/ti", "react-icons/vsc", "react-icons/wi"], "useCacheTimeout": 54, "instantInsights": { "validationLevel": "warning" }, "trustHostHeader": false, "isExperimentalCompile": false }, "htmlLimitedBots": "[\\w-]+-Google|Google-[\\w-]+|Chrome-Lighthouse|Slurp|DuckDuckBot|baiduspider|yandex|sogou|bitlybot|tumblr|vkShare|quora link preview|redditbot|ia_archiver|Bingbot|BingPreview|applebot|facebookexternalhit|facebookcatalog|Twitterbot|LinkedInBot|Slackbot|Discordbot|WhatsApp|SkypeUriPreview|Yeti|googleweblight", "bundlePagesRouterDependencies": false, "configFileName": "next.config.ts", "repoRoot": "D:\\Projects\\Client\\Araththaai", "turbopack": { "root": "D:\\Projects\\Client\\Araththaai" }, "distDirRoot": ".next" };
var BuildId = "YZ1MiWqj7cwc68aQm3CSh";
var RoutesManifest = { "basePath": "", "rewrites": { "beforeFiles": [], "afterFiles": [], "fallback": [] }, "redirects": [{ "source": "/:path+/", "destination": "/:path+", "internal": true, "priority": true, "statusCode": 308, "regex": "^(?:/((?:[^/]+?)(?:/(?:[^/]+?))*))/$" }], "routes": { "static": [{ "page": "/", "regex": "^/(?:/)?$", "routeKeys": {}, "namedRegex": "^/(?:/)?$" }, { "page": "/_global-error", "regex": "^/_global\\-error(?:/)?$", "routeKeys": {}, "namedRegex": "^/_global\\-error(?:/)?$" }, { "page": "/_not-found", "regex": "^/_not\\-found(?:/)?$", "routeKeys": {}, "namedRegex": "^/_not\\-found(?:/)?$" }, { "page": "/about", "regex": "^/about(?:/)?$", "routeKeys": {}, "namedRegex": "^/about(?:/)?$" }, { "page": "/admin", "regex": "^/admin(?:/)?$", "routeKeys": {}, "namedRegex": "^/admin(?:/)?$" }, { "page": "/admin/consultations", "regex": "^/admin/consultations(?:/)?$", "routeKeys": {}, "namedRegex": "^/admin/consultations(?:/)?$" }, { "page": "/api/auth/register", "regex": "^/api/auth/register(?:/)?$", "routeKeys": {}, "namedRegex": "^/api/auth/register(?:/)?$" }, { "page": "/api/booking", "regex": "^/api/booking(?:/)?$", "routeKeys": {}, "namedRegex": "^/api/booking(?:/)?$" }, { "page": "/book", "regex": "^/book(?:/)?$", "routeKeys": {}, "namedRegex": "^/book(?:/)?$" }, { "page": "/contact", "regex": "^/contact(?:/)?$", "routeKeys": {}, "namedRegex": "^/contact(?:/)?$" }, { "page": "/favicon.ico", "regex": "^/favicon\\.ico(?:/)?$", "routeKeys": {}, "namedRegex": "^/favicon\\.ico(?:/)?$" }, { "page": "/services", "regex": "^/services(?:/)?$", "routeKeys": {}, "namedRegex": "^/services(?:/)?$" }, { "page": "/sign-in", "regex": "^/sign\\-in(?:/)?$", "routeKeys": {}, "namedRegex": "^/sign\\-in(?:/)?$" }], "dynamic": [{ "page": "/api/auth/[...nextauth]", "regex": "^/api/auth/(.+?)(?:/)?$", "routeKeys": { "nxtPnextauth": "nxtPnextauth" }, "namedRegex": "^/api/auth/(?<nxtPnextauth>.+?)(?:/)?$" }, { "page": "/api/trpc/[trpc]", "regex": "^/api/trpc/([^/]+?)(?:/)?$", "routeKeys": { "nxtPtrpc": "nxtPtrpc" }, "namedRegex": "^/api/trpc/(?<nxtPtrpc>[^/]+?)(?:/)?$" }, { "page": "/services/[slug]", "regex": "^/services/([^/]+?)(?:/)?$", "routeKeys": { "nxtPslug": "nxtPslug" }, "namedRegex": "^/services/(?<nxtPslug>[^/]+?)(?:/)?$" }], "data": { "static": [], "dynamic": [] } }, "locales": [] };
var ConfigHeaders = [];
var PrerenderManifest = { "version": 4, "routes": { "/": { "routeType": "page", "response": "complete", "compute": "static", "htmlSize": 104374, "experimentalBypassFor": [{ "type": "header", "key": "next-action" }, { "type": "header", "key": "content-type", "value": "multipart/form-data;.*" }], "initialRevalidateSeconds": false, "srcRoute": "/", "dataRoute": "/index.rsc", "allowHeader": ["host", "x-matched-path", "x-prerender-revalidate", "x-prerender-revalidate-if-generated", "x-next-revalidated-tags", "x-next-revalidate-tag-token"] }, "/_global-error": { "routeType": "page", "response": "complete", "compute": "static", "htmlSize": 9203, "experimentalBypassFor": [{ "type": "header", "key": "next-action" }, { "type": "header", "key": "content-type", "value": "multipart/form-data;.*" }], "initialRevalidateSeconds": false, "srcRoute": "/_global-error", "dataRoute": "/_global-error.rsc", "allowHeader": ["host", "x-matched-path", "x-prerender-revalidate", "x-prerender-revalidate-if-generated", "x-next-revalidated-tags", "x-next-revalidate-tag-token"] }, "/_not-found": { "initialStatus": 404, "routeType": "page", "response": "complete", "compute": "static", "htmlSize": 15930, "experimentalBypassFor": [{ "type": "header", "key": "next-action" }, { "type": "header", "key": "content-type", "value": "multipart/form-data;.*" }], "initialRevalidateSeconds": false, "srcRoute": "/_not-found", "dataRoute": "/_not-found.rsc", "allowHeader": ["host", "x-matched-path", "x-prerender-revalidate", "x-prerender-revalidate-if-generated", "x-next-revalidated-tags", "x-next-revalidate-tag-token"] }, "/about": { "routeType": "page", "response": "complete", "compute": "static", "htmlSize": 32445, "experimentalBypassFor": [{ "type": "header", "key": "next-action" }, { "type": "header", "key": "content-type", "value": "multipart/form-data;.*" }], "initialRevalidateSeconds": false, "srcRoute": "/about", "dataRoute": "/about.rsc", "allowHeader": ["host", "x-matched-path", "x-prerender-revalidate", "x-prerender-revalidate-if-generated", "x-next-revalidated-tags", "x-next-revalidate-tag-token"] }, "/admin": { "routeType": "page", "response": "complete", "compute": "static", "htmlSize": 24954, "experimentalBypassFor": [{ "type": "header", "key": "next-action" }, { "type": "header", "key": "content-type", "value": "multipart/form-data;.*" }], "initialRevalidateSeconds": false, "srcRoute": "/admin", "dataRoute": "/admin.rsc", "allowHeader": ["host", "x-matched-path", "x-prerender-revalidate", "x-prerender-revalidate-if-generated", "x-next-revalidated-tags", "x-next-revalidate-tag-token"] }, "/admin/consultations": { "routeType": "page", "response": "complete", "compute": "static", "htmlSize": 30257, "experimentalBypassFor": [{ "type": "header", "key": "next-action" }, { "type": "header", "key": "content-type", "value": "multipart/form-data;.*" }], "initialRevalidateSeconds": false, "srcRoute": "/admin/consultations", "dataRoute": "/admin/consultations.rsc", "allowHeader": ["host", "x-matched-path", "x-prerender-revalidate", "x-prerender-revalidate-if-generated", "x-next-revalidated-tags", "x-next-revalidate-tag-token"] }, "/book": { "routeType": "page", "response": "complete", "compute": "static", "htmlSize": 32211, "experimentalBypassFor": [{ "type": "header", "key": "next-action" }, { "type": "header", "key": "content-type", "value": "multipart/form-data;.*" }], "initialRevalidateSeconds": false, "srcRoute": "/book", "dataRoute": "/book.rsc", "allowHeader": ["host", "x-matched-path", "x-prerender-revalidate", "x-prerender-revalidate-if-generated", "x-next-revalidated-tags", "x-next-revalidate-tag-token"] }, "/contact": { "routeType": "page", "response": "complete", "compute": "static", "htmlSize": 41903, "experimentalBypassFor": [{ "type": "header", "key": "next-action" }, { "type": "header", "key": "content-type", "value": "multipart/form-data;.*" }], "initialRevalidateSeconds": false, "srcRoute": "/contact", "dataRoute": "/contact.rsc", "allowHeader": ["host", "x-matched-path", "x-prerender-revalidate", "x-prerender-revalidate-if-generated", "x-next-revalidated-tags", "x-next-revalidate-tag-token"] }, "/favicon.ico": { "initialHeaders": { "cache-control": "public, max-age=0, must-revalidate", "content-type": "image/x-icon", "x-next-cache-tags": "_N_T_/layout,_N_T_/favicon.ico/layout,_N_T_/favicon.ico/route,_N_T_/favicon.ico" }, "routeType": "route", "response": "complete", "compute": "static", "experimentalBypassFor": [{ "type": "header", "key": "next-action" }, { "type": "header", "key": "content-type", "value": "multipart/form-data;.*" }], "initialRevalidateSeconds": false, "srcRoute": "/favicon.ico", "dataRoute": null, "allowHeader": ["host", "x-matched-path", "x-prerender-revalidate", "x-prerender-revalidate-if-generated", "x-next-revalidated-tags", "x-next-revalidate-tag-token"] }, "/services": { "routeType": "page", "response": "complete", "compute": "static", "htmlSize": 85209, "experimentalBypassFor": [{ "type": "header", "key": "next-action" }, { "type": "header", "key": "content-type", "value": "multipart/form-data;.*" }], "initialRevalidateSeconds": false, "srcRoute": "/services", "dataRoute": "/services.rsc", "allowHeader": ["host", "x-matched-path", "x-prerender-revalidate", "x-prerender-revalidate-if-generated", "x-next-revalidated-tags", "x-next-revalidate-tag-token"] }, "/services/corporate-law": { "routeType": "page", "response": "complete", "compute": "static", "htmlSize": 33957, "experimentalBypassFor": [{ "type": "header", "key": "next-action" }, { "type": "header", "key": "content-type", "value": "multipart/form-data;.*" }], "initialRevalidateSeconds": false, "srcRoute": "/services/[slug]", "dataRoute": "/services/corporate-law.rsc", "allowHeader": ["host", "x-matched-path", "x-prerender-revalidate", "x-prerender-revalidate-if-generated", "x-next-revalidated-tags", "x-next-revalidate-tag-token"] }, "/services/criminal-defense": { "routeType": "page", "response": "complete", "compute": "static", "htmlSize": 33777, "experimentalBypassFor": [{ "type": "header", "key": "next-action" }, { "type": "header", "key": "content-type", "value": "multipart/form-data;.*" }], "initialRevalidateSeconds": false, "srcRoute": "/services/[slug]", "dataRoute": "/services/criminal-defense.rsc", "allowHeader": ["host", "x-matched-path", "x-prerender-revalidate", "x-prerender-revalidate-if-generated", "x-next-revalidated-tags", "x-next-revalidate-tag-token"] }, "/services/family-law": { "routeType": "page", "response": "complete", "compute": "static", "htmlSize": 33699, "experimentalBypassFor": [{ "type": "header", "key": "next-action" }, { "type": "header", "key": "content-type", "value": "multipart/form-data;.*" }], "initialRevalidateSeconds": false, "srcRoute": "/services/[slug]", "dataRoute": "/services/family-law.rsc", "allowHeader": ["host", "x-matched-path", "x-prerender-revalidate", "x-prerender-revalidate-if-generated", "x-next-revalidated-tags", "x-next-revalidate-tag-token"] }, "/services/property-law": { "routeType": "page", "response": "complete", "compute": "static", "htmlSize": 33845, "experimentalBypassFor": [{ "type": "header", "key": "next-action" }, { "type": "header", "key": "content-type", "value": "multipart/form-data;.*" }], "initialRevalidateSeconds": false, "srcRoute": "/services/[slug]", "dataRoute": "/services/property-law.rsc", "allowHeader": ["host", "x-matched-path", "x-prerender-revalidate", "x-prerender-revalidate-if-generated", "x-next-revalidated-tags", "x-next-revalidate-tag-token"] }, "/services/startup-compliance": { "routeType": "page", "response": "complete", "compute": "static", "htmlSize": 33703, "experimentalBypassFor": [{ "type": "header", "key": "next-action" }, { "type": "header", "key": "content-type", "value": "multipart/form-data;.*" }], "initialRevalidateSeconds": false, "srcRoute": "/services/[slug]", "dataRoute": "/services/startup-compliance.rsc", "allowHeader": ["host", "x-matched-path", "x-prerender-revalidate", "x-prerender-revalidate-if-generated", "x-next-revalidated-tags", "x-next-revalidate-tag-token"] }, "/services/taxation": { "routeType": "page", "response": "complete", "compute": "static", "htmlSize": 33673, "experimentalBypassFor": [{ "type": "header", "key": "next-action" }, { "type": "header", "key": "content-type", "value": "multipart/form-data;.*" }], "initialRevalidateSeconds": false, "srcRoute": "/services/[slug]", "dataRoute": "/services/taxation.rsc", "allowHeader": ["host", "x-matched-path", "x-prerender-revalidate", "x-prerender-revalidate-if-generated", "x-next-revalidated-tags", "x-next-revalidate-tag-token"] }, "/sign-in": { "routeType": "page", "response": "complete", "compute": "static", "htmlSize": 13154, "experimentalBypassFor": [{ "type": "header", "key": "next-action" }, { "type": "header", "key": "content-type", "value": "multipart/form-data;.*" }], "initialRevalidateSeconds": false, "srcRoute": "/sign-in", "dataRoute": "/sign-in.rsc", "allowHeader": ["host", "x-matched-path", "x-prerender-revalidate", "x-prerender-revalidate-if-generated", "x-next-revalidated-tags", "x-next-revalidate-tag-token"] } }, "dynamicRoutes": { "/api/auth/[...nextauth]": { "experimentalBypassFor": [{ "type": "header", "key": "next-action" }, { "type": "header", "key": "content-type", "value": "multipart/form-data;.*" }], "routeRegex": "^/api/auth/(.+?)(?:/)?$", "dataRoute": null, "fallback": null, "fallbackRootParams": [], "fallbackRouteParams": [], "dataRouteRegex": null, "prefetchDataRoute": null, "allowHeader": ["host", "x-matched-path", "x-prerender-revalidate", "x-prerender-revalidate-if-generated", "x-next-revalidated-tags", "x-next-revalidate-tag-token"] }, "/api/trpc/[trpc]": { "experimentalBypassFor": [{ "type": "header", "key": "next-action" }, { "type": "header", "key": "content-type", "value": "multipart/form-data;.*" }], "routeRegex": "^/api/trpc/([^/]+?)(?:/)?$", "dataRoute": null, "fallback": null, "fallbackRootParams": [], "fallbackRouteParams": [], "dataRouteRegex": null, "prefetchDataRoute": null, "allowHeader": ["host", "x-matched-path", "x-prerender-revalidate", "x-prerender-revalidate-if-generated", "x-next-revalidated-tags", "x-next-revalidate-tag-token"] }, "/services/[slug]": { "routeType": "page", "response": "empty", "compute": "blocking", "experimentalBypassFor": [{ "type": "header", "key": "next-action" }, { "type": "header", "key": "content-type", "value": "multipart/form-data;.*" }], "routeRegex": "^/services/([^/]+?)(?:/)?$", "dataRoute": "/services/[slug].rsc", "fallback": null, "fallbackRootParams": [], "fallbackRouteParams": [], "dataRouteRegex": "^/services/([^/]+?)\\.rsc$", "prefetchDataRoute": null, "allowHeader": ["host", "x-matched-path", "x-prerender-revalidate", "x-prerender-revalidate-if-generated", "x-next-revalidated-tags", "x-next-revalidate-tag-token"] } }, "notFoundRoutes": [], "preview": { "previewModeId": "c395cfaa9f2fb21eb16d60d820403466", "previewModeSigningKey": "96a31e73980966abd3a2ada111e4058846c230f8ec29246eedcadf211e1f66da", "previewModeEncryptionKey": "bf23b83f8becfae90e9d2d183263d41c7684d792dc994045c6e7d60f31c10a0b" } };
var MiddlewareManifest = { "version": 3, "middleware": { "/": { "files": ["server/edge/chunks/node_modules_next_dist_esm_build_templates_edge-wrapper_0_kjzx3.js", "server/edge/chunks/[root-of-the-server]__0emy-m4._.js", "server/edge/chunks/turbopack-node_modules_next_dist_esm_build_templates_edge-wrapper_0a9xbl8.js"], "name": "middleware", "page": "/", "entrypoint": "server/edge/chunks/turbopack-node_modules_next_dist_esm_build_templates_edge-wrapper_0a9xbl8.js", "matchers": [{ "regexp": "^(?:\\/(_next\\/data\\/[^/]{1,}))?\\/admin(?:\\/((?:[^\\/#\\?]+?)(?:\\/(?:[^\\/#\\?]+?))*))?(\\.json|\\.rsc|\\.segments\\/.+\\.segment\\.rsc)?[\\/#\\?]?$", "originalSource": "/admin/:path*" }], "wasm": [], "assets": [], "env": { "__NEXT_BUILD_ID": "YZ1MiWqj7cwc68aQm3CSh", "NEXT_SERVER_ACTIONS_ENCRYPTION_KEY": "UgsiGrTNaoDC6oM8YB9459hNW4s7FqIZwaZHfMV9hbU=", "__NEXT_PREVIEW_MODE_ID": "c395cfaa9f2fb21eb16d60d820403466", "__NEXT_PREVIEW_MODE_ENCRYPTION_KEY": "bf23b83f8becfae90e9d2d183263d41c7684d792dc994045c6e7d60f31c10a0b", "__NEXT_PREVIEW_MODE_SIGNING_KEY": "96a31e73980966abd3a2ada111e4058846c230f8ec29246eedcadf211e1f66da" } } }, "sortedMiddleware": ["/"], "functions": {} };
var AppPathRoutesManifest = { "/(public)/about/page": "/about", "/(public)/book/page": "/book", "/(public)/contact/page": "/contact", "/(public)/page": "/", "/(public)/services/[slug]/page": "/services/[slug]", "/(public)/services/page": "/services", "/_global-error/page": "/_global-error", "/_not-found/page": "/_not-found", "/admin/consultations/page": "/admin/consultations", "/admin/page": "/admin", "/api/auth/[...nextauth]/route": "/api/auth/[...nextauth]", "/api/auth/register/route": "/api/auth/register", "/api/booking/route": "/api/booking", "/api/trpc/[trpc]/route": "/api/trpc/[trpc]", "/favicon.ico/route": "/favicon.ico", "/sign-in/page": "/sign-in" };
