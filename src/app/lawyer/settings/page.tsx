        ...
        <div className="grid grid-cols-1 md:grid-cols-4">
          <div className="p-6 border-b md:border-b-0 md:border-r border-gray-200 bg-gray-50/50">
            <nav className="flex flex-row md:flex-col gap-1 overflow-x-auto">
              <button className="flex items-center gap-3 px-3 py-2 text-sm font-medium rounded-md bg-white text-primary shadow-sm w-full">
                <User className="h-4 w-4" /> Profile
              </button>
              <button className="flex items-center gap-3 px-3 py-2 text-sm font-medium rounded-md text-gray-600 hover:bg-gray-100 hover:text-gray-900 w-full text-left">
