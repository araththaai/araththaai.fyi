      ...
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="text-center mb-16">
          ...
          <h1 className="text-4xl md:text-5xl font-heading font-bold text-primary mb-4">
            {language === "en" ? "Privacy Policy" : language === "ta" ? "தனியுரிமைக் கொள்கை" : "गोपनीयता नीति"}
          </h1>
        ...
        <div className="bg-card border border-border p-8 md:p-12 rounded-2xl shadow-sm prose prose-slate max-w-none text-muted-foreground leading-relaxed">
          <p className="lead text-lg text-foreground font-medium mb-6">
            {language === "en"
              ...
              : "अरथाई (एकेएम एसोसिएट्स एंड लीगल कंसल्टेंट्स) में, हम क्लाइंट गोपनीयता और डेटा सुरक्षा को सर्वोच्च प्राथमिकता देते हैं। यह नीति विस्तार से बताती है कि हम जानकारी कैसे एकत्र करते हैं, सुरक्षित रखते हैं और उसका उपयोग करते हैं।"}
          </p>

          <h2 className="text-2xl font-heading font-bold text-primary mt-8 mb-4">
            {language === "en" ? "1. Attorney-Client Privilege & Confidentiality" : language === "ta" ? "1. வழக்கறிஞர்-வாடிக்கையாளர் ரகசியத்தன்மை" : "1. वकील-क्लाइंट विशेषाधिकार और गोपनीयता"}
          </h2>
          <p className="mb-6">
            {language === "en"
              ...
              : "इस मंच के माध्यम से प्रस्तुत सभी पत्राचार, परामर्श और दस्तावेज़ अपलोड प्रासंगिक बार नियमों के तहत सख्त पेशेवर गोपनीयता और वकील-क्लाइंट विशेषाधिकार नियमों के अधीन हैं। हम कानून द्वारा अधिकृत या बाध्य किए जाने तक किसी भी क्लाइंट के मामले का विवरण प्रकट नहीं करते हैं।"}
          </p>

          <h2 className="text-2xl font-heading font-bold text-primary mt-8 mb-4">
            {language === "en" ? "2. Information We Collect" : language === "ta" ? "2. நாங்கள் சேகரிக்கும் தகவல்கள்" : "2. जानकारी जो हम एकत्र करते हैं"}
          </h2>
          <p className="mb-4">
            {language === "en"
              ...
              : "हम वह जानकारी एकत्र करते हैं जो आप परामर्श निर्धारित करते समय या पूछताछ सबमिट करते समय स्वेच्छा से हमें प्रदान करते हैं।"}
          </p>
          <ul className="list-disc pl-6 mb-6 space-y-2 text-sm">
            <li>
              <strong>{language === "en" ? "Identity & Contact Info:" : language === "ta" ? "அடையாளம் & தொடர்பு விபரங்கள்:" : "पहचान और संपर्क जानकारी:"}</strong>{" "}
              {language === "en" ? "Full name, telephone number, email address." : language === "ta" ? "முழு பெயர், தொலைபேசி எண், மின்னஞ்சல் முகவரி." : "पूरा नाम, टेलीफोन नंबर, ईमेल पता।"}
            </li>
            <li>
              <strong>{language === "en" ? "Case-Related Information:" : language === "ta" ? "வழக்கு தொடர்பான தகவல்கள்:" : "मामले से संबंधित जानकारी:"}</strong>{" "}
              {language === "en" ? "Brief descriptions of your legal matter, documents uploaded for review, and booking dates." : language === "ta" ? "உங்கள் சட்ட விவகாரங்களின் சுருக்கம், மதிப்பாய்வுக்கான ஆவணங்கள் மற்றும் முன்பதிவு தேதிகள்." : "आपके कानूनी मामले का संक्षिप्त विवरण, समीक्षा के लिए अपलोड किए गए दस्तावेज़ और बुकिंग की तिथियां।"}
            </li>
            <li>
              <strong>{language === "en" ? "Technical Data:" : language === "ta" ? "தொழில்நுட்பத் தரவுகள்:" : "तकनीकी डेटा:"}</strong>{" "}
              {language === "en" ? "Anonymized usage data, browser specifications, and connection details to optimize system performance." : language === "ta" ? "தளத்தின் செயல்திறனை மேம்படுத்துவதற்கான அநாமதேய பயன்பாட்டுத் தரவுகள் மற்றும் இணைப்பு விவரங்கள்." : "सिस्टम के प्रदर्शन को अनुकूलित करने के लिए अज्ञात उपयोग डेटा, ब्राउज़र विनिर्देश और कनेक्शन विवरण।"}
            </li>
          </ul>

          <h2 className="text-2xl font-heading font-bold text-primary mt-8 mb-4">
            {language === "en" ? "3. How We Use Your Data" : language === "ta" ? "3. உங்கள் தரவை நாங்கள் எவ்வாறு பயன்படுத்துகிறோம்" : "3. हम आपके डेटा का उपयोग कैसे करते हैं"}
          </h2>
          <p className="mb-6">
            {language === "en"
              ...
              : "आपकी जानकारी का उपयोग केवल आपके मामले का मूल्यांकन करने, बुकिंग अनुरोधों को संसाधित करने, शेड्यूलिंग अपडेट संचारित करने और कानूनी प्रतिनिधित्व शुरू होने से पहले आवश्यक हितों के टकराव की जांच का पालन करने के लिए किया जाता है। हम कभी भी क्लाइंट की जानकारी को तीसरे पक्षों को बेचते, किराए पर देते या व्यापार नहीं करते हैं।"}
          </p>

          <h2 className="text-2xl font-heading font-bold text-primary mt-8 mb-4">
            {language === "en" ? "4. Data Security" : language === "ta" ? "4. தரவு பாதுகாப்பு" : "4. डेटा सुरक्षा"}
          </h2>
          <p className="mb-6">
            {language === "en"
              ...
              : "हम आपकी जानकारी को संग्रहीत करने के लिए एंटरप्राइज-ग्रेड एन्क्रिप्शन और सुरक्षित पहुंच नियंत्रण का उपयोग करते हैं। अपलोड किए गए दस्तावेज़ स्थानांतरण और भंडारण के दौरान एन्क्रिप्ट किए जाते हैं। हालांकि हम आपके डेटा की सुरक्षा के लिए हर संभव उपाय करते हैं, किसी भी इलेक्ट्रॉनिक प्रणाली के 100% सुरक्षित होने की गारंटी नहीं दी जा सकती है।"}
          </p>

          <h2 className="text-2xl font-heading font-bold text-primary mt-8 mb-4">
            {language === "en" ? "5. Contact Our Compliance Team" : language === "ta" ? "5. இணக்கக் குழுவைத் தொடர்பு கொள்ளவும்" : "5. हमारी अनुपालन टीम से संपर्क करें"}
          </h2>
          <p className="mb-6">
            {language === "en"
              ...
              : "यदि हमारी गोपनीयता नीतियों के बारे में आपके कोई प्रश्न हैं, या आप हमारे इनटेक सिस्टम से अपने व्यक्तिगत रिकॉर्ड को हटाने का अनुरोध करना चाहते हैं, तो कृपया हमारे अनुपालन विभाग से संपर्क करें: "}{" "}
