    ...
    <div className="py-24 bg-surface min-h-[85vh] flex items-center justify-center">
      <div className="max-w-xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
        ...
        <h2 className="text-3xl font-heading font-bold text-primary mb-4">
          {language === "en" ? "Internal Court Adjournment" : "உள் சேவையகப் பிழை"}
        </h2>
        ...
        <div className="flex flex-col sm:flex-row gap-4 justify-center">
          <Button 
            ...
            className="w-full sm:w-auto bg-primary text-primary-foreground hover:bg-primary/90 h-12 px-6 cursor-pointer"
          >
            <RefreshCw className="mr-2 h-4 w-4" /> {language === "en" ? "Reload Page" : "மீண்டும் ஏற்றுக"}
          </Button>
          <a href="mailto:akmattorney@gmail.com">
            <Button size="lg" variant="outline" className="w-full sm:w-auto border-border text-foreground hover:bg-muted h-12 px-6 cursor-pointer">
              <Mail className="mr-2 h-4 w-4" /> {language === "en" ? "Email Support" : "மின்னஞ்சல் ஆதரவு"}
            </Button>
          </a>
        </div>
      </div>
