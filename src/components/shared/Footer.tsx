...
export function Footer() {
  return (
    <footer className="bg-primary text-primary-foreground pt-16 pb-8 border-t border-white/5">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12 mb-12">
          ...
          {/* Directory Links */}
          <div>
            <h3 className="font-heading font-semibold text-sm mb-6 text-white uppercase tracking-wider">Quick Links</h3>
          ...
          {/* Practice Areas */}
          <div>
            <h3 className="font-heading font-semibold text-sm mb-6 text-white uppercase tracking-wider">Practice Areas</h3>
            <ul className="space-y-3 text-xs text-gray-300">
          ...
          {/* Contact coordinates */}
          <div>
            <h3 className="font-heading font-semibold text-sm mb-6 text-white uppercase tracking-wider">Contact Info</h3>
        ...
        <div className="border-t border-gray-800 pt-8 pb-6 flex flex-col gap-4 text-[10px] text-gray-400">
          <div className="flex items-start gap-2 bg-white/5 p-4 rounded border border-white/5">
          ...
          <div className="flex flex-col md:flex-row justify-between items-center gap-4 text-xs">
            ...
            <div className="flex space-x-6">
              <Link to="/disclaimer" className="hover:text-white transition-colors">Advertising Disclaimer</Link>
