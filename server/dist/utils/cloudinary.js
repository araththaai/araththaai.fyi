...
cloudinary.config({
    cloud_name: process.env.CLOUDINARY_CLOUD_NAME || process.env.NEXT_PUBLIC_CLOUDINARY_CLOUD_NAME || 'r0lvbyu3',
 ...
 */
export async function uploadToCloudinary(buffer, folder = 'araththaai_uploads', resourceType = 'auto') {
